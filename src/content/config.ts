...
const cases = defineCollection({
  ...
  schema: z.object({
    ...
    osVersion: z.union([z.string(), z.array(z.string())]).optional(),
    device: z.union([z.string(), z.array(z.string())]),
    deviceVersion: z.union([z.string(), z.array(z.string())]).optional(),
    browser: z.union([z.string(), z.array(z.string())]),
    browserVersion: z.union([z.string(), z.array(z.string())]).optional(),
    keyboard: z.string(),
    caseTitle: z.string(),
