...
description: "When the dir attribute is changed dynamically on a contenteditable region (e.g., switching between ltr and rtl), the text direction may not update correctly during active editing in Firefox."
tags:
  - direction
  - rtl
  - ltr
