...
description: "After copying selected text in a contenteditable region using Cmd+C, the selection is lost in Safari. The user must re-select the text to perform additional operations."
tags:
  - copy
  - selection
  - safari
...
domSteps:
  ...
  - label: "After Copy (Bug)"
    ...
    description: "After copy, selection is cleared and collapsed to cursor"
  - label: "✅ Expected"
    html: 'Hello <span style="background: #bfdbfe;">World</span> Test'
    description: "Expected: Selection state maintained after copy"
---
