---
id: ce-0273-caret-invisible-relative-firefox-windows-en-ko
...
caseTitle: Text caret invisible on position:relative elements (Firefox)
description: "In Firefox on Windows, when editing content inside an element with `position:relative`, the text caret (cursor) is completely invisible. Text appears but no visual feedback of insertion point."
tags:
  - caret
  - cursor
  - css
